...
## Corpus Check
- 110 files · ~478,028 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 449 nodes · 611 edges · 44 communities (31 shown, 13 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 1 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `03989729`
...
1. `requireAdmin()` - 19 edges
2. `compilerOptions` - 16 edges
3. `ÁPEX Saúde — Setup Supabase` - 10 edges
4. `useUser()` - 9 edges
5. `main()` - 8 edges
6. `valorMock()` - 8 edges
7. `IndicadorConfig` - 8 edges
8. `ÁPEX Saúde Next — Instruções para Agentes` - 8 edges
9. `criarClienteSupabase()` - 7 edges
10. `include` - 7 edges
...
Cohesion: 0.11
Nodes (24): IaPage(), IndicadorCard(), IndicadorCardProps, STATUS_STYLES, EQUIPE_IDS, EquipeConfig, formatarMeta(), formatarValor() (+16 more)
...
Cohesion: 0.08
Nodes (23): E, ESTADOS, Ind, M, U, CheckListInterativa(), Props, GuiaEquipePage() (+15 more)
...
Cohesion: 0.24
Nodes (13): EquipeId, EquipeInstancia, indicadoresDoTipo(), MUNICIPIO_MOCK, MunicipioConfig, calcularNotaEquipe(), classificacaoDaNota(), FATOR_CLASSIFICACAO (+5 more)
...
Cohesion: 0.13
Nodes (21): GET(), PUT(), supabase, DELETE(), GET(), MunicipioRow, POST(), PUT() (+13 more)
...
## Knowledge Gaps
- **171 isolated node(s):** `supabase`, `CLASSIFICACOES`, `TIPOS`, `Props`, `Schema ativo (producao)` (+166 more)
...
- **What connects `supabase`, `CLASSIFICACOES`, `TIPOS` to the rest of the system?**
